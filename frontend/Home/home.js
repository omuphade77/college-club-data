...
function findMatch() {
  ...
  let interests = Array.from(selected).map(el => el.innerText);
  ...
  if (interests.some(i => i.includes("Technology"))) {
    ...
    description = "Perfect for tech enthusiasts who love innovation!";
  } 
  else  if (interests.some(i => i.includes("Academic Excellence"))) {
    match = "Community of Coders";
    description = "Perfect for tech enthusiasts who love coding!";
  } 
    ...
    match = "Swacch VJTI";
    description = "Best for those who care about sustainability and environment!";
  } 
  else if (interests.some(i => i.includes("Finance"))) {
    match = "Ecell VJTI";
    description = "Great for managing budgets and organizing resources!";
  } 
